...
│   └── webfang_test_utils/       # shared dev/test-support crate
```
...
MCP tools: 36 tools across 9 categories. Transport: Streamable HTTP (`rmcp`) at `127.0.0.1:8080/mcp`, also stdio via `mcp_server_stdio` example.
