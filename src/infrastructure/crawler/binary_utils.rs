...
///
/// ```
/// use rust_scraper::infrastructure::crawler::binary_utils::percent_decode;
///
...
///
/// ```
/// use rust_scraper::infrastructure::crawler::binary_utils::derive_filename_from_response;
/// use url::Url;
///
...
///
/// ```
/// use rust_scraper::infrastructure::crawler::binary_utils::parse_content_disposition;
///
/// assert_eq!(
