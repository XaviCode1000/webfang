...
fuzz_target!(|data: &[u8]| {
    if let Ok(s) = std::str::from_utf8(data) {
        let _ = webfang::infrastructure::crawler::link_extractor::normalize_url(
            s,
            &webfang::domain::url_validation::NormalizeConfig {
                strip_www: true,
                query_policy: webfang::domain::url_validation::RemoveQueryParameters::All,
            },
        );
    }
});
