...
/// ```rust,ignore
/// use std::sync::Arc;
/// use rust_scraper_core::adapters::downloader::{Downloader, DownloadConfig};
...
mod tests {
    ...
    fn test_clean_html_logic() {
        ...
        let cleaned = rust_scraper_core::infrastructure::converter::html_cleaner::clean_html(html);
    ...
    fn test_waf_detector_logic() {
        ...
        let result = rust_scraper_core::infrastructure::http::waf_engine::WafInspector::detect_body(
            clean_html,
        );
    ...
    fn test_waf_detector_cloudflare() {
        ...
        let result =
            rust_scraper_core::infrastructure::http::waf_engine::WafInspector::detect_body(cf_html);
    ...
    fn test_output_path_logic() {
        let path = rust_scraper_core::adapters::url_path::OutputPath::from_url(
    ...
    fn test_frontmatter_generation() {
        let fm = rust_scraper_core::infrastructure::output::frontmatter::generate(
            "Test Title",
            "https://example.com",
            None,
            None,
    ...
    fn test_mcp_state_with_downloader() {
        ...
        let dl_config = rust_scraper_core::adapters::downloader::DownloadConfig {
            output_dir: tmp.path().to_path_buf(),
            ..Default::default()
        };
        let downloader =
            Arc::new(rust_scraper_core::adapters::downloader::Downloader::new(dl_config).unwrap());
