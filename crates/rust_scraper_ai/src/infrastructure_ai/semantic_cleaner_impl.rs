...
//!
//! This module provides the concrete implementation of the [`SemanticCleaner`](rust_scraper_core::domain::semantic_cleaner::SemanticCleaner)
...
use rust_scraper_core::domain::semantic_cleaner::{private, SemanticCleaner};
use rust_scraper_core::domain::DocumentChunk;
use rust_scraper_core::error::SemanticError;
