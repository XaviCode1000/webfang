...
pub const SELECTOR: OptionSpec = OptionSpec {
    ...
    default: Some(DefaultValue::Str("body")),
...
pub const DELAY_MS: OptionSpec = OptionSpec {
    ...
    default: Some(DefaultValue::Uint(1000)),
    nullable: false,
    description_override: None,
...
pub const MAX_PAGES: OptionSpec = OptionSpec {
    ...
    default: Some(DefaultValue::Uint(10)),
    nullable: false,
    description_override: None,
...
pub const MAX_DEPTH: OptionSpec = OptionSpec {
    ...
    default: Some(DefaultValue::Uint(2)),
    nullable: false,
    description_override: None,
...
pub const MAX_RETRIES: OptionSpec = OptionSpec {
    ...
    default: Some(DefaultValue::Uint(3)),
    nullable: false,
    description_override: None,
...
pub const BACKOFF_MAX_MS: OptionSpec = OptionSpec {
    ...
    default: Some(DefaultValue::Uint(10000)),
    nullable: false,
    description_override: None,
...
pub const ACCEPT_LANGUAGE: OptionSpec = OptionSpec {
    ...
    default: Some(DefaultValue::Str("en-US,en;q=0.9")),
...
pub const MAX_FILE_SIZE: OptionSpec = OptionSpec {
    ...
    default: Some(DefaultValue::Uint(52428800)),
    nullable: false,
    description_override: None,
...
pub const H2_PROFILE: OptionSpec = OptionSpec {
    ...
    default: Some(DefaultValue::Str("Chrome145")),
...
pub const JS_STRATEGY: OptionSpec = OptionSpec {
        ...
        default: Some(DefaultValue::Str("static")),
...
pub const OBSCURA_BINARY: OptionSpec = OptionSpec {
    ...
    default: Some(DefaultValue::Str("obscura")),
