...
// `EnvGuard::entry_guard_off` since #1396: these behavioral tests pin the
// parse/discover pipeline against wiremock, not the entry guard (pinned
// separately in `sitemap_ssrf_e2e_test`).
